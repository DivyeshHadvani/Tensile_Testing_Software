...
class mark10_f_values_distal(QtCore.QThread):
    ...
    def __init__(self):
        super(mark10_f_values_distal, self).__init__()
        # self.com = "COM3"
                ...
                if available_bytes >= 8:
                    try:
                        ...
                        self.present_reading = abs(
                            round((self.read_value - self.zero_value), 2))
                    except:
                        pass
            except:
                self.s.close()
...
#     print("i am here in random_generator")
...
#         self.gg = gg
#         self.emp = 1
#         print("i am here in random_generator init")

#     def run(self):
#         print("i am here in random_generator run")
#         self.times = []
#         self.val = []
#         i = 0
#         start = time.time()
